...
struct thread
  {
    ...
    struct list donors;                 /* Mod: @kaist.ac.kr, Previously "donation", renamed. */
...
/* Mod: @kaist.ac.kr, given condition */
#define NICE_MAX      20
#define NICE_MIN      -20
...
extern struct list sleep_list;             /* Mod: @kaist.ac.kr */
...
void thread_set_recent_cpu_one (struct thread *t, void *aux UNUSED);
...
bool tick_compare (const struct list_elem *a, const struct list_elem *b, void *aux UNUSED);
